...
return true;
    ...
    if ($_SESSION['loggedin'] == 1)
       ...
       $_SESSION['URI'] = 'http://5033857.unaux.com'.$_SERVER['REQUEST_URI']; //save current url for redirect     
       header('Location: http://5033857.unaux.com/index.php', true, 303);       
    }       
}
...
function login($id,$username) {
   ...
   if ($_SESSION['loggedin'] == 0 and !empty($_SESSION['URI']))        
     ...
     $_SESSION['URI'] =  'http://5033857.unaux.com/index.php';         
     $uri = $_SESSION['URI'];           
   }  
