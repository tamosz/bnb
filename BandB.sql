...
CREATE TABLE IF NOT EXISTS booking (
  ...
  bookingExtras text,
  roomReview text,
  breakfastType enum('continental','cooked') NOT NULL,
...
INSERT INTO booking (bookingID, checkinDate, checkoutDate, contactNumber, bookingExtras, roomReview, breakfastType, customerID, roomID) VALUES
(1, '2021-10-13', '2021-10-21', '1231231234', NULL, NULL, 'continental', 5, 1),
(2, '2021-10-21', '2021-10-28', '1231231234', NULL, NULL, 'continental', 4, 2);
COMMIT;