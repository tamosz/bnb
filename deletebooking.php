...
echo '<div id="content">';
?>
<html><head><title>Booking deletion preview</title> </head>
 <body>
...
if (empty($id) or !is_numeric($id)) {
 echo "<h2>Invalid Booking ID, possibly deleted</h2>"; //simple error feedback
 echo "<h2><a href='listbookings.php'>[Return to the Booking listing]</a><a href='/bnb/'>[Return to the main page]</a></h2>";
 exit;
} 
...
//save the booking data if the error flag is still clear and booking id is > 0
  if ($error == 0 and $id > 0 and ($_POST['submit'] == 'Delete')) {
...
?>
<h1>Booking deletion preview</h1>
